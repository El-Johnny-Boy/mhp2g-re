...
| +0x068   | 0x48    | unknown3             |                                         |
| +0xb0    | 0x2ee0  | equipmentChest[1000] | EquipmentSlotData, 12 bytes/slot        |
| +0x2f90  | 0xfa0   | itemChest[1000]      | ItemSlotData, 4 bytes/slot              |
| +0x3f30  | 0x60    | inventory[24]        | ItemSlotData, 4 bytes/slot              |
| +0x3f90  | 0x40    | unknown4             |                                         |
| +0x3fd0  | 0x8     | timePlayed           | in seconds, stored as 64 bits integer   |
| +0x3fd8  | 0x667dc | unknwown5            | a lot of things, need to look into it   |
